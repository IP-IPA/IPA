...
/* -----\/----- EXCLUDED -----\/-----
module instmem_pe #(parameter WRITE_AWIDTH = 5, parameter WRITE_DWIDTH = 64, parameter READ_AWIDTH = 6, parameter READ_DWIDTH = 20)
(
 input logic 	     Clk, Write_En, Reset, exec_en,
 input logic [WRITE_AWIDTH-1:0]   Write_Addr,
 input logic [WRITE_DWIDTH-1:0]  In_Inst,
 ...
 output logic [READ_DWIDTH-1:0] Inst_Data
   ...
   logic [15:0] [WRITE_DWIDTH-1:0] im ;
...
//end
always_comb begin
   if(Inst_Addr == 5'b00000) begin
      Inst_Data <= im[0][63:44];
   end else if(Inst_Addr == 5'b00001) begin
      Inst_Data <= im[0][43:24];
   end else if(Inst_Addr == 5'b00010) begin
      Inst_Data <= im[0][23:4];
   end else if(Inst_Addr == 5'b00011) begin
      Inst_Data[19:16] <= im[0][3:0];
      Inst_Data[15:0] <= im[1][63:48];
   end else if(Inst_Addr == 5'b00100) begin
      Inst_Data <= im[1][47:28];
   end else if(Inst_Addr == 5'b00101) begin
      Inst_Data <= im[1][27:8];
   end else if(Inst_Addr == 5'b00110) begin
      Inst_Data[19:12] <= im[1][7:0];
      Inst_Data[11:0] <= im[2][63:52];
   end else if(Inst_Addr == 5'b00111) begin
      Inst_Data <= im[2][51:32];
   end else if(Inst_Addr == 5'b01000) begin
      Inst_Data <= im[2][31:12];
   end else if(Inst_Addr == 5'b01001) begin
      Inst_Data[19:8] <= im[2][11:0];
      Inst_Data[7:0] <= im[3][63:56];
   end else if(Inst_Addr == 5'b01010) begin
      Inst_Data <= im[3][55:36];
   end else if(Inst_Addr == 5'b01011) begin
      Inst_Data <= im[3][35:16];
   end else if(Inst_Addr == 5'b01100) begin
      Inst_Data[19:4] <= im[3][15:0];
      Inst_Data[3:0] <= im[4][63:60];
   end  else if(Inst_Addr == 5'b01101) begin
      Inst_Data <= im[4][59:40];
   end else if(Inst_Addr == 5'b01110) begin
      Inst_Data <= im[4][39:20];
   end else if(Inst_Addr == 5'b01111) begin
      Inst_Data <= im[4][19:0];
   end  else if(Inst_Addr == 5'b10000) begin
      Inst_Data <= im[5][63:44];
   end else if(Inst_Addr == 5'b10001) begin
      Inst_Data <= im[5][43:24];
   end else if(Inst_Addr == 5'b10010) begin
      Inst_Data <= im[5][23:4];
   end  else if(Inst_Addr == 5'b10011) begin
      Inst_Data[19:16] <= im[5][3:0];
      Inst_Data[15:0] <= im[6][63:48];
   end else if(Inst_Addr == 5'b10100) begin
      Inst_Data <= im[6][47:28];
   end else if(Inst_Addr == 5'b10101) begin
      Inst_Data <= im[6][27:8];
   end  else if(Inst_Addr == 5'b10110) begin
      Inst_Data[19:12] <= im[6][7:0];
      Inst_Data[11:0] <= im[7][63:52];
   end else if(Inst_Addr == 5'b10111) begin
      Inst_Data <= im[7][51:32];
   end else if(Inst_Addr == 5'b11000) begin
      Inst_Data <= im[7][31:12];
   end  else if(Inst_Addr == 5'b11001) begin
      Inst_Data[19:8] <= im[7][11:0];
      Inst_Data[7:0] <= im[8][63:56];
   end else if(Inst_Addr == 5'b11010) begin
      Inst_Data <= im[8][55:36];
   end else if(Inst_Addr == 5'b11011) begin
      Inst_Data <= im[8][35:16];
   end  else if(Inst_Addr == 5'b11100) begin
      Inst_Data[19:4] <= im[8][15:0];
      Inst_Data[3:0] <= im[9][63:60];
   end else if(Inst_Addr == 5'b11101) begin
      Inst_Data <= im[9][59:40];
   end else if(Inst_Addr == 5'b11110) begin
      Inst_Data <= im[9][39:20];
   end  else if(Inst_Addr == 5'b11111) begin
      Inst_Data <= im[9][19:0];
   end   
end
endmodule
